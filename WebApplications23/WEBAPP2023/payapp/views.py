...
class UserRegistration(CreateView):
    ...
    model = User
    template_name = 'payapp/user_registration_form.html'
...
class UserResetPwd(UpdateView, PermissionRequiredMixin):
    ...
    model = User
    template_name = 'payapp/user_reset_pwd_form.html'
    success_url = 'user_login'
    permission_required = 'payapp.change_user'
...
class UserProfile(LoginRequiredMixin, ListView, PermissionRequiredMixin):
    model = User
    template_name = 'payapp/user_profile_form.html'
    permission_required = 'payapp.view_profile'


class UserProfileUpdate(LoginRequiredMixin, UpdateView, PermissionRequiredMixin):
    model = User
    form_class = UserForm
    template_name = 'payapp/user_profile_update.html'
    permission_required = 'payapp.change_profile'
...
class AccountList(LoginRequiredMixin, ListView, PermissionRequiredMixin):
    model = User
    template_name = 'payapp/account_list.html'
    permission_required = 'payapp.view_account'
...
class AccountTransfer(LoginRequiredMixin, View, PermissionRequiredMixin):
    permission_required = 'payapp.change_account'
    ...
    def get(self, request, pk):
        ...
        return render(request, 'payapp/account_transfer_confirm.html', {'account': account, 'nbar': 'account'})
...
class BankList(LoginRequiredMixin, ListView, PermissionRequiredMixin):
    ...
    permission_required = 'payapp.view_bank'
...
class BankCreate(LoginRequiredMixin, CreateView, PermissionRequiredMixin):
    ...
    model = Bank
    template_name = 'payapp/bank_create.html'
    permission_required = 'payapp.add_bank'
...
class BankUpdate(LoginRequiredMixin, UpdateView, PermissionRequiredMixin):
    ...
    template_name = 'payapp/bank_update.html'
    permission_required = 'payapp.change_bank'
...
class BankDelete(LoginRequiredMixin, DeleteView, PermissionRequiredMixin):
    model = Bank
    template_name = 'payapp/bank_confirm_delete.html'
    permission_required = 'payapp.delete_bank'
...
class CardList(LoginRequiredMixin, ListView, PermissionRequiredMixin):
    ...
    permission_required = 'payapp.view_card'
...
class CardCreate(LoginRequiredMixin, CreateView, PermissionRequiredMixin):
    ...
    model = Card
    template_name = 'payapp/card_create.html'
    permission_required = 'payapp.add_card'
...
class CardUpdate(LoginRequiredMixin, UpdateView, PermissionRequiredMixin):
    ...
    template_name = 'payapp/card_update.html'
    permission_required = 'payapp.add_card'
...
class CardDelete(LoginRequiredMixin, DeleteView, PermissionRequiredMixin):
    model = Card
    template_name = 'payapp/card_confirm_delete.html'
    permission_required = 'payapp.delete_card'
...
class ActivityList(LoginRequiredMixin, ListView, PermissionRequiredMixin):
    model = Transaction
    template_name = 'payapp/activity_list.html'
    permission_required = 'payapp.view_transaction'
...
class SendSearchUser(LoginRequiredMixin, ListView):
    ...
    template_name = 'payapp/send_search_user_form.html'
...
class SendMoney(LoginRequiredMixin, CreateView, PermissionRequiredMixin):
    ...
    model = Transaction
    template_name = 'payapp/send_money_form.html'
    permission_required = 'payapp.add_transaction'
...
class SendSuccess(LoginRequiredMixin, View):
    def get(self, request):
        return render(request, 'payapp/send_success_page.html', {'nbar': 'send'})


class RequestSearchUser(LoginRequiredMixin, ListView):
    model = User
    form_class = SearchUserForm
    template_name = 'payapp/request_search_user_form.html'
...
class RequestMoney(LoginRequiredMixin, CreateView, PermissionRequiredMixin):
    ...
    model = Transaction
    template_name = 'payapp/request_money_form.html'
    permission_required = 'payapp.add_transaction'
...
class RequestSuccess(LoginRequiredMixin, View):
    def get(self, request):
        return render(request, 'payapp/request_success_page.html', {'nbar': 'request'})


class IncompleteTranList(LoginRequiredMixin, ListView, PermissionRequiredMixin):
    model = Transaction
    template_name = 'payapp/incomplete_list.html'
    permission_required = 'payapp.view_transaction'
...
class IncompletePayment(LoginRequiredMixin, View, PermissionRequiredMixin):
    ...
    def get(self, request, pk):
        ...
        return render(
            request,
            'payapp/incomplete_payment.html',
...
class IncompletePaymentConfirm(LoginRequiredMixin, UpdateView, PermissionRequiredMixin):
    ...
    template_name = 'payapp/payment_confirm.html'
    permission_required = 'payapp.change_transaction'
...
class PaymentComplete(LoginRequiredMixin, View):
    def get(self, request):
        return render(request, 'payapp/payment_success.html', {'nbar': 'incomplete'})
...
class IncompleteRequest(LoginRequiredMixin, View, PermissionRequiredMixin):
    ...
    def get(self, request, pk):
        ...
        return render(
            request,
            'payapp/incomplete_request.html',
            {'tran': transaction, 'user': self.request.user, 'nbar': 'incomplete'}
        )
...
class IncompleteRequestDelete(LoginRequiredMixin, DeleteView, PermissionRequiredMixin):
    model = Transaction
    template_name = 'payapp/request_delete.html'
    success_url = reverse_lazy('incomplete')
    permission_required = 'payapp.delete_transaction'
...
class StaffUserList(LoginRequiredMixin, ListView, PermissionRequiredMixin):
    ...
    permission_required = 'payapp.view_user'
...
class StaffUserPayment(LoginRequiredMixin, ListView, PermissionRequiredMixin):
    ...
    permission_required = ('payapp.view_account', 'payapp.view_bank', 'payapp.view_card')
...
class CurrencyConverterView(View):
    template_name = 'payapp/form.html'
    ...
    def post(self, request):
        ...
        return render(request, 'payapp/result.html', context)